...
const items = [
  {
    ...
    title: "BlogSpot",
    img: Blogspot,
    desc: "BlogSpot will be developed using the MERN (MongoDB, Express.js, React.js, Node.js) stack, incorporating modern web development technologies for a robust and scalable solution. The MERN stack provides a comprehensive and integrated framework for building web applications, ensuring efficiency and flexibility throughout the development process.",
    list: [
    ...
    Github: "https://github.com/FaizanHaider108/mern-blogging-platform.git",
  },
  {
    id: 2,
    title: "NextLand.pk",
  ...
  },
  {
    ...
    list: ["React.js", "Framer Motion", "HTML5 and CSS3", "Responsive Design"],
  ...
  },
  {
    ...
    Github:
      "https://github.com/FaizanHaider108/project_syncfusion_dashboard/tree/Dashboard",
  },
  {
    id: 5,
    ...
    img: Restourant,
    desc: "This project showcases my proficiency in frontend development, utilizing React.js and Framer Motion to deliver a seamless and visually engaging user experience.",
    list: ["React.js", "Slider", "HTML5 and CSS3", "Responsive Design"],
